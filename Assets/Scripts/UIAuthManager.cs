...
public class UIAuthManager : MonoBehaviour
{
    ...
    private void Start()
    {
        // ƒобавить проверку на первый запуск игры и открытие меню регистрации
    ...
    public void OnAuthorization() // ѕереход к меню авторизации
    {
        _registrationMenu.DOAnchorPos(_transformOffset, _movementTime);
        _authMenu.DOAnchorPos(Vector2.zero, _movementTime);
    }

    public void OnRegistration() // ѕереход к меню регистрации
    {
